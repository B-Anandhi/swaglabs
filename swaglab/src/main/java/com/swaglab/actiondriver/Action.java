 ...
 * 
 */
package com.swaglab.actiondriver;
...
import com.swaglab.actionInterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public void pageLoadTimeOut(WebDriver driver, int timeOut) {
		...
		WebDriverWait wait = new WebDriverWait(getDriver(), 300000 /*timeout in seconds*/);
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8082/job/MyStoreProject/ws/MyStoreProject/ScreenShot/" + filename + "_"
				+ dateName + ".png";
